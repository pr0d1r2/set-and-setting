...
# Prints skillPath,rulePath,condField to stdout if found; exits 1
# with known agent names on stderr if not found.
# Env in: AGENT_SEAMS (agent=skillPath,rulePath,condField;...),
#   AGENT_NAME (name to resolve)
set -euo pipefail
