...
- V50: A limit that one legitimate outlier cannot meet is loosened FOR THAT FILE,
  ...
  work -- skills and docs. `config/lefthook/file_size_limits.yml` now carries a
  `paths:` entry, and the exemption is visible where the limit lives.
